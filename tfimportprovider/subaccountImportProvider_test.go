...
func TestCreateSubaccountImportBlock(t *testing.T) {
	...
	jsonString := "{\"beta_enabled\": false,\"created_by\":\"someone@sap.com\",\"created_date\":\"2024-09-11T10:32:19Z\",\"description\":\"\",\"id\":\"12345\",\"labels\": null,\"last_modified\":\"2024-09-11T10:32:42Z\",\"name\":\"btptfexporter\",\"parent_features\": null,\"parent_id\":\"543121\",\"region\":\"us10\",\"state\":\"OK\",\"subdomain\":\"btptfexporter\",\"usage\":\"NOT_USED_FOR_PRODUCTION\"}"
	...
	tests := []struct {
...

		{
			...
			subaccountId:  "12345",
			filterValues:  []string{},
			expectedBlock: "import {\n\t\t\t\tto = btp_subaccount.btptfexporter\n\t\t\t\tid = \"12345\"\"\n\t\t\t  }\n\n",
			expectError:   false,
		},
		{
			...
			data:          dataSubaccount,
			subaccountId:  "12345",
			filterValues:  []string{"btptfexporter"},
			expectedBlock: "import {\n\t\t\t\tto = btp_subaccount.btptfexporter\n\t\t\t\tid = \"12345\"\"\n\t\t\t  }\n\n",
			expectError:   false,
		},
		{
